...
public class GatlingApp {

    private static final Logger log = LoggerFactory.getLogger(GatlingApp.class);

    private final Environment env;

    public GatlingApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GatlingApp.class);
